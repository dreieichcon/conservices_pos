...
using Innkeep.Client.Services.Legacy.Interfaces.Pretix;
using Innkeep.Client.Services.Legacy.Interfaces.Server;
using Innkeep.Client.Services.Legacy.Interfaces.Transaction;
using Innkeep.Models.Transaction;
using Innkeep.Server.Services.Legacy.Models;
using Innkeep.Server.Services.Legacy.Util;

namespace Innkeep.Client.Services.Legacy.Services.Transaction;
